...
if __name__ == '__main__':
    ...
    print('LR train accuracy:', accur(pred_class, trainY))
    ...
    print('DT train accuracy:', accur(pred_class, trainY))
    ...
    model.fit(trainX, trainY)
    pred = model.predict(testX)
    print('custom random forest accuracy: ', accur(pred, testY))


    pred_class = model.predict(trainX)
    print('random forest train accuracy:', accur(pred_class, trainY))
